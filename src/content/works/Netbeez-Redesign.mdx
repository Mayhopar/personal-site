...
description: Overhauling B2B network analytics tool
date: 2024-04-06
link: https://netbeez.net/
...
import Gridelli from './images/People/gridelli.jpeg';
import Neophytou from './images/People/neophytou.jpeg';
import Chernobai from './images/People/chernobai.jpeg';
...
<Image class='' src={Scheme} alt='Scheme with Netbeez system main variables'/>
...
<video class="rounded-md lg:rounded-xl aspect-video object-cover object-top" muted playsinline autoplay loop no-controls preload="auto" src={ScreenMap}>
</video>
...
<video class="rounded-md lg:rounded-xl aspect-video object-cover object-top" muted playsinline autoplay loop no-controls preload="auto" src={Estimation}>
</video>
...
<video class="rounded-md lg:rounded-xl aspect-video object-cover object-top" muted playsinline autoplay loop no-controls preload="auto" src={Layout}>
</video>
...
<CreditWrapper>
    <Credit src={Gridelli} url="https://www.linkedin.com/in/stefanogridelli/" name="Stefano Gridelli" role="CEO & co-founder"/>
    <Credit src={Neophytou} url="https://www.linkedin.com/in/panickos/" name="Panickos Neophytou" role="CTO & co-founder"/>
    <Credit src={Lysevich} url="https://www.linkedin.com/in/unpositive/" name="Anton Lysevich" role="Product manager"/>
    <Credit src={Chernobai} url="https://www.linkedin.com/in/yana-chernobai-864041151/" name="Yana Chernobai" role="Lead product designer"/>
</CreditWrapper>