...
<video class="rounded-md lg:rounded-xl aspect-video object-cover object-top" muted playsinline autoplay loop preload="auto">
  <source src={ScreenMap + '#t=0.001'} type="video/mp4"/>
</video>
...
<video class="rounded-md lg:rounded-xl aspect-video object-cover object-top" muted playsinline autoplay loop preload="auto">
  <source src={Estimation + '#t=0.001'} type="video/mp4"/>
</video>
...
<video class="rounded-md lg:rounded-xl aspect-video object-cover object-top" muted playsinline autoplay loop preload="auto">
  <source src={Layout + '#t=0.001'} type="video/mp4"/>
</video>
