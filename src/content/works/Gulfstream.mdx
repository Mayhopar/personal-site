...
<video class='rounded-md lg:rounded-xl' src={Concept} playsinline autoplay loop muted/>
...
<video class='rounded-md lg:rounded-xl' src={Demo} playsinline autoplay loop muted/>
