...
<video class='rounded-md lg:rounded-2xl' src={Concept} playsinline autoplay loop muted/>
...
<video class='rounded-md lg:rounded-2xl' src={Demo} playsinline autoplay loop muted/>
