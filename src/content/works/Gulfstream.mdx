...
description: Creating world's best smart jet app
date: 2024-04-05
...
import Borzov from './images/People/borzov.jpg';
import Golota from './images/People/golota.jpeg';
import Krupa from './images/People/krupeinikov.jpeg';
...
<video class='rounded-md lg:rounded-xl' src={Concept} playsinline autoplay loop muted no-controls preload="auto"/>
...
<video class='rounded-md lg:rounded-xl' src={Demo} playsinline autoplay loop muted no-controls preload="auto"/>
...
<CreditWrapper>
    <Credit src={Borzov} url="https://www.linkedin.com/in/tyggy/" name="Anton Borzov" role="Advisor"/>
    <Credit src={Golota} url="https://www.linkedin.com/in/julia-golota-5baa443/" name="Julia Golota" role="Account manager"/>
    <Credit src={Krupa} url="https://www.linkedin.com/in/krupenikov/" name="Ilya Krupeinikov" role="Account manager"/>
