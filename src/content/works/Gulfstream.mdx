...
<video class='rounded-md lg:rounded-xl' src={Concept} playsinline autoplay loop muted preload="auto"/>
...
<video class='rounded-md lg:rounded-xl' src={Demo} playsinline autoplay loop muted preload="auto"/>
