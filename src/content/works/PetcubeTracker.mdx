...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={Wireframes} playsinline autoplay loop muted preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={LostDogVid} playsinline autoplay loop muted preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={MovingHistoryVid} playsinline autoplay loop muted preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={MovingGoalVid} playsinline autoplay loop muted preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={Fence} playsinline autoplay loop muted preload="auto"/>
...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={ProductPage} playsinline autoplay loop muted preload="auto"/>
