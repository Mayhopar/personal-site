...
description: Launching pet activity GPS tracker in the US
date: 2024-04-03
link: https://petcube.com/tracker/
...
import CreditWrapper from '../../components/CreditWrapper.astro';
...
import Klen from './images/People/klen.jpeg';
import Smieltsov from './images/People/smieltsov.jpeg';
import Kachanovsky from './images/People/kachanovsky.jpeg';
import Shevchuk from './images/People/shevshuk.jpeg';
import Kasian from './images/People/kasian.jpeg';
import Lysevich from './images/People/lysevich.jpeg';
...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={Wireframes} playsinline autoplay loop muted no-controls preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={LostDogVid} playsinline autoplay loop muted no-controls preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={MovingHistoryVid} playsinline autoplay loop muted no-controls preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={MovingGoalVid} playsinline autoplay loop muted no-controls preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={Fence} playsinline autoplay loop muted no-controls preload="auto"/>
...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={ProductPage} playsinline autoplay loop muted no-no-controls preload="auto"/>
...
<CreditWrapper>
    <Credit src={Klen} url="https://www.linkedin.com/in/andreyklen/" name="Andriy Klen" role="CMO & co-founder"/>
    <Credit src={Smieltsov} url="https://www.linkedin.com/in/smltsw/" name="Oleh Smieltsov" role="Lead product designer"/>
    <Credit src={Kachanovsky} url="https://www.linkedin.com/in/denys-kachanovsky-7062111a8/" name="Denys Kachanovsky" role="Product designer"/>
    <Credit src={Shevchuk} url="https://www.linkedin.com/in/alexshevchuk/" name="Alex Shevchuk" role="CPO"/>
    <Credit src={Kasian} url="https://www.linkedin.com/in/liz-kasian/" name="Liz Kasian" role="Product manager"/>
    <Credit src={Lysevich} url="https://www.linkedin.com/in/unpositive/" name="Anton Lysevich" role="Product manager"/>
</CreditWrapper>