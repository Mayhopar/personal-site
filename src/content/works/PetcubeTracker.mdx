...
<image class='border-[1px] border-gray-100 !rounded-md' alt='Figjam file with competitor analysis' src='/src/content/works/images/PetcubeTracker/competitors.png'/>
...
<video class='border-[1px] border-gray-100 rounded-md' src='/src/content/works/images/PetcubeTracker/petcubeWireframes.mp4' autoplay loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md' src={LostDogVid} autoplay loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md' src={MovingHistoryVid} autoplay loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md' src={MovingGoalVid} autoplay loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md' src={Fence} autoplay loop muted/>
...
<video class='border-[1px] border-gray-100 rounded-md' src={ProductPage} autoplay loop muted/>
...
<image src="/src/content/works/images/PetcubeTracker/ph.png" alt="Screenshot of Petcube Tracker page on Product Hunt"/>
