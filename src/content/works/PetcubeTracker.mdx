...
<Image class='border-[1px] border-gray-100 !rounded-md lg:rounded-2xl' alt='Figjam file with competitor analysis' src={CompAnalysis}/>
...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-2xl' src={Wireframes} playsinline autoplay loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-2xl' src={LostDogVid} playsinline autoplay loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-2xl' src={MovingHistoryVid} playsinline autoplay loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-2xl' src={MovingGoalVid} playsinline autoplay loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-2xl' src={Fence} playsinline autoplay loop muted/>
...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-2xl' src={ProductPage} playsinline autoplay loop muted/>
