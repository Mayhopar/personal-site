...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={Wireframes} playsinline loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={LostDogVid} playsinline loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={MovingHistoryVid} playsinline loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={MovingGoalVid} playsinline loop muted/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={Fence} playsinline loop muted/>
...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={ProductPage} playsinline loop muted/>
