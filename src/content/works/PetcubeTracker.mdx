...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={Wireframes + '#t=0.001'} playsinline autoplay loop muted preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={LostDogVid + '#t=0.001'} playsinline autoplay loop muted preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={MovingHistoryVid + '#t=0.001'} playsinline autoplay loop muted preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={MovingGoalVid + '#t=0.001'} playsinline autoplay loop muted preload="auto"/>
...
<video class='aspect-square object-cover border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={Fence + '#t=0.001'} playsinline autoplay loop muted preload="auto"/>
...
<video class='border-[1px] border-gray-100 rounded-md lg:rounded-xl' src={ProductPage + '#t=0.001'} playsinline autoplay loop muted preload="auto"/>
