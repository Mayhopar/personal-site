...
<Image class='border-[1px] border-gray-100 !rounded-md' alt='Figjam file with competitor analysis' src={CompAnalysis}/>
...
<video class='border-[1px] border-gray-100 rounded-md' src={Wireframes} autoplay loop muted/>
