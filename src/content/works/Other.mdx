...
preview1: '/src/content/works/images/misc/preview01.png'
preview2: '/src/content/works/images/misc/preview02.png'
preview3: '/src/content/works/images/misc/preview03.png'
---
...
<details class="">
  ...
  **Petcube Care** is a subscription service that enhances Petcube camera functionalities with features like extended video history, smart alerts, and automatic video recording for comprehensive pet and home monitoring:
  ...
  <br/>
  ### New Video Timeline
  <SingleImage alt='' src={careTimeline}/>
  * Churn 0.37% ↓
  * Playback 22% ↑
  
  <br/>
  ### Onboarding
  <SingleImage alt='' src={careOnboarding}/>
  * CR 17% ↑
  
  <br/>
  ### Upsells and experiments
  <SingleImage alt='' src={careUpsell}/>
  * Trial CR 30% ↑
  * MRR 9% ↑
...
<details class="">
  ...
  <div class="content">
    ...
    <ImageVideo lsrc={PlancaRetouch} lalt="Before and after of retouched photo" rsrc={PlancaSession} caption=" 1. The most money I spent on the project was two hours of studio and the light rent. My retouching skills came in handy; 2. The main format was 1 to 1 training, but we also experimented with group training, hoping that this would attract more people."/> 
...
<details class="">
  <summary class=""><span>Details</span></summary> 
  <div class="content">
    <SingleImage alt='Main screen of the Portrait user portal' src={PortraitMain} customClass="!mb-0"/>
    <DoubleImage lalt='Scheme of the service' lsrc={PortraitSchemeL} ralt='Wireframes' rsrc={PortraitSchemeR} customClass="!mt-5 !mb-0"/>
    <SingleVideo src={PortraitLayout} customClass="!mt-5 !mb-0 [&>video]:!mt-0"/>
    <DoubleImage lalt='Few icons from the iconset' lsrc={PortraitIcons} ralt='UI elements' rsrc={PortraitUI} customClass="!mt-5 !mb-0"/>
    <DoubleImage lalt='Mobile screen' lsrc={PortraitMobile} ralt='Dark theme preview' rsrc={PortraitDark} customClass="!mt-5 !mb-0"/>
    <SingleImage alt='Few mobile screens' src={PortraitMobileMore} customClass="!mt-5"/>
  </div>
</details>
